...
if ( !function_exists( 'do_issuem_image' ) ) {

	/**
	 * Outputs Issue Cover image HTML from shortcode call
	 *
	 * @param array $atts Arguments passed through shortcode
	 * @return string HTML output of Issue Cover Image
	 */

	function do_issuem_image( $atts ) {
		...
		$issue_data = get_term_by( $field, $issue, 'issuem_issue' );
	...
	add_shortcode( 'issuem_issue_image', 'do_issuem_image' );
}
